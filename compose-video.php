...
<body>
    ...
    <main>
        ...
        <section class="compose__input-container">
            ...
            <div>
                <img id="compose__input-video" src="./assets/video-placeholder.svg" alt="">
                <iframe id="compose__input-video-preview"
                    frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
            </div>
            <textarea id="compose__input-subtitle" type="text" placeholder="Add a Description" rows="4"></textarea>
        </section>
    </main>
    ...
    <section id="dialog-container">
        <div id="photo-upload__dialog">
            <section class="dialog__header">
                <span class="dialog__title">Embed a Video</span>
                <svg onclick="hideVideoUploadDialog()" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
            ...
            <section class="photo-upload__body">
                <input id="input__embed-link" class="dialog__input" type="url" placeholder="Youtube Link">
                <label for="photo-upload__button-choose">
                    <span class="button-outlined--secondary" onclick="showPreview()">Choose</span>
                </label>
            </section>
        </div>
    </section>
...
<script src="./js/compose-video.js"></script>
</html>